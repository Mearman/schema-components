...
// The schema-input → value-type inference helpers (`InferFields`,
// `InferredOutputValue`, `InferredInputValue`, `InferredValue`) live in
// `core/inferValue.ts` so the HTML entry points can consume them without
// taking a dependency on the React layer. Re-exported here so the public
// React surface and existing imports against
// `react/SchemaComponent` keep working unchanged.
export type {
    InferFields,
    InferredOutputValue,
    InferredInputValue,
