...
| [`SchemaView`](https://mearman.github.io/schema-components/functions/react_SchemaView.SchemaView.html) | `react/SchemaView` | Function | Server-safe schema renderer — no context and no state. | [Server Rendering/SchemaView](https://mearman.github.io/schema-components/storybook/?path=/docs/server-rendering-schemaview--docs) |
...
| [`recursionSentinelHtml`](https://mearman.github.io/schema-components/functions/html_renderToHtml.recursionSentinelHtml.html) | `html/renderToHtml` | Function | Build the recursion-cap sentinel element. |  |
| [`renderToHtml`](https://mearman.github.io/schema-components/functions/html_renderToHtml.renderToHtml.html) | `html/renderToHtml` | Function | Render a schema to an HTML string. | [HTML Rendering/Static](https://mearman.github.io/schema-components/storybook/?path=/docs/html-rendering-static--docs) |
...
| [`renderToHtmlChunks`](https://mearman.github.io/schema-components/functions/html_renderToHtmlStream.renderToHtmlChunks.html) | `html/renderToHtmlStream` | Function | Render a schema as an iterable of HTML string chunks. | [HTML Rendering/Streaming](https://mearman.github.io/schema-components/storybook/?path=/docs/html-rendering-streaming--docs) |
| [`renderToHtmlReadable`](https://mearman.github.io/schema-components/functions/html_renderToHtmlStream.renderToHtmlReadable.html) | `html/renderToHtmlStream` | Function | Render a schema as a web `ReadableStream<string>`. | [HTML Rendering/Streaming](https://mearman.github.io/schema-components/storybook/?path=/docs/html-rendering-streaming--docs) |
...
| [`registerMantineComponents`](https://mearman.github.io/schema-components/functions/themes_mantine.registerMantineComponents.html) | `themes/mantine` | Function | Register real Mantine components for the resolver to use. |  |
...
| [`registerMuiComponents`](https://mearman.github.io/schema-components/functions/themes_mui.registerMuiComponents.html) | `themes/mui` | Function | Register real MUI components. |  |
...
| [`registerRadixComponents`](https://mearman.github.io/schema-components/functions/themes_radix.registerRadixComponents.html) | `themes/radix` | Function | Register real Radix Themes components for the resolver to use. |  |
