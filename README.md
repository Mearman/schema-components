...
| [`getExternalDocs`](https://mearman.github.io/schema-components/functions/openapi_parser.getExternalDocs.html) | `openapi/parser` | Function | Read the optional `externalDocs` field on an OpenAPI object (document, operation, tag, schema, ...) into an ExternalDocs record. |  |
| [`getLinks`](https://mearman.github.io/schema-components/functions/openapi_parser.getLinks.html) | `openapi/parser` | Function | List the OpenAPI link definitions declared on a specific response of a single operation, returning each link's parsed LinkInfo entry. |  |
| [`getParameters`](https://mearman.github.io/schema-components/functions/openapi_parser.getParameters.html) | `openapi/parser` | Function | Resolve the parameters of a single operation, merging path-level parameters with operation-level overrides and following any Parameter Object `$ref` chains. |  |
| [`getRequestBody`](https://mearman.github.io/schema-components/functions/openapi_parser.getRequestBody.html) | `openapi/parser` | Function | Resolve the request body of a single operation, including its declared content types and schema. |  |
| [`getResponseHeaders`](https://mearman.github.io/schema-components/functions/openapi_parser.getResponseHeaders.html) | `openapi/parser` | Function | Resolve the headers of a single OpenAPI Response Object as a map of header name to HeaderInfo. |  |
| [`getResponses`](https://mearman.github.io/schema-components/functions/openapi_parser.getResponses.html) | `openapi/parser` | Function | Resolve the responses of a single operation, returning one ResponseInfo per declared status code (including class wildcards and `default`). |  |
| [`getSchema`](https://mearman.github.io/schema-components/functions/openapi_parser.getSchema.html) | `openapi/parser` | Function | Resolve a `$ref` string against a parsed OpenAPI document. |  |
| [`getSecurityRequirements`](https://mearman.github.io/schema-components/functions/openapi_parser.getSecurityRequirements.html) | `openapi/parser` | Function | Resolve the effective security requirements for a single operation. |  |
| [`getSecuritySchemes`](https://mearman.github.io/schema-components/functions/openapi_parser.getSecuritySchemes.html) | `openapi/parser` | Function | Read the document's `components.securitySchemes` map as a map of scheme names to SecurityScheme entries. |  |
| [`getXmlInfo`](https://mearman.github.io/schema-components/functions/openapi_parser.getXmlInfo.html) | `openapi/parser` | Function | Read the optional `xml` keyword on a JSON Schema object into an XmlInfo record describing how the field is serialised in an XML payload. |  |
...
| [`listWebhooks`](https://mearman.github.io/schema-components/functions/openapi_parser.listWebhooks.html) | `openapi/parser` | Function | List every OpenAPI 3.1 webhook declared under the document's `webhooks` map, each with its name and resolved operations. |  |
...
| [`parseOpenApiDocument`](https://mearman.github.io/schema-components/functions/openapi_parser.parseOpenApiDocument.html) | `openapi/parser` | Function | Build an OpenApiDocument from a raw OpenAPI JSON object. |  |
